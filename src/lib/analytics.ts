...
export function calculateLinearRegression(
  ...
  // sumY2 is calculated but not used in current implementation
  // Keep for potential future use in advanced statistics
  const _sumY2 = yValues.reduce((sum, y) => sum + y * y, 0);
